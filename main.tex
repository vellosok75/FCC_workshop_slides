...
\begin{frame}{SIRIUS storage ring}
    ...
    \begin{minipage}{0.62\textwidth}
        \scriptsize
        4th generation storage ring based Synchrotron Light Source. Designed, built and operated by the Brazilian Synchrotron Light Laboratory (LNLS), at the Brazilian Center for Research in Energy and Materials (CNPEM), Campinas, Brazil.\\
...
\begin{frame}{Off-axis injection scheme}
    ...
    %     \begin{figure}
    %         \centering
    %         \includegraphics[width=0.8\textwidth]{nlk_phase_space.png}
    %     \end{figure}
    % \end{minipage}
    % \begin{minipage}{0.49\textwidth}
    %     \begin{itemize}
...
\begin{frame}{RCDS Dynamic Aperture Optimization Setup}
    \begin{minipage}{0.6\textwidth}
        ...
        \tiny
        More details:\\
        M. M. S. Velloso, M. B. Alves,  L. Liu, X. R. Resende, F. H. de Sá, and X. Huang, in \emph{Proc. IPAC'23} Venezia, 05 2023, pp. 3222-3226\\
        {\tiny About RCDS:\\
...
\begin{frame}{Improvements to orbit stability}
...
\begin{frame}{Summary}
    ...
    \item injection efficiency $\centernot\implies$ larger kick resiliency/larger phase portrait areas
\end{itemize}
