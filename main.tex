...
\begin{frame}{RCDS Dynamic Aperture Optimization Setup}
    \begin{minipage}{0.6\textwidth}
        ...
        \begin{itemize}
        \item objective function: avg. injection efficiency of 5 pulses @ $\unit{2~Hz}$ ($\sigma\approx1\%$)
        \begin{itemize}
            \scriptsize
        ...
        \end{itemize}
        \item  Tuning in 3 machine working points: higher fractional tunes for improved orbit stability
        \end{itemize}
        \vfill
        \tiny
        More details:\\
