...
\begin{frame}{Measurements at SIRIUS storage ring}
    ...
    Measurment
    \begin{itemize}
        \item We excited the beam by driving the CMs of each of the \textbf{20 sectors} present in the Sirius storage ring.
        \item At each sector, the \textbf{6 CHs} drove frequencies $f_x = 3,  7, 13, 19, 29, 37\ \unit{Hz}$ and the \textbf{8 CVs} drove frequencies $f_y = 5, 11, 17, 23, 31, 41, 47, 59\ \unit{Hz}$.
        \item  The complete measurement took around $2.5-3\ \unit{min}$ to be completed
    \end{itemize}
\end{frame}
\end{document}
